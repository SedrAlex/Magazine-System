...
const ArticlesEditForm = ({fid, closeEvent }) => {
...
useEffect(() => {
  ...
  const updateArticle = async (event) => {
    ...
    formData.append("content", editorContent); // Append the editor's content

    // Append the image file to formData
    formData.append("imageLink", image); 
    axios
      .post(
        "https://www.tanaghomtech.com/magazine/public/api/article/updateArticle",
      ...
      .then((response) => {
        ...
        getArticles();
        closeEvent();
        Swal.fire("تم تعديل معلومات المقال", "تم تعديل معلومات المقال بشكل صحيح", "success");
      })
      .catch((error) => {
